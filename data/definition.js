...
const fileAnswers = "StudiengaengeUndAntworten.csv";
...
const descriptionHeading1 = "Bachelor Wirtschaftsingenieur";


// 	1.6.3. Zweite Ueberschrift / 1.6.2. Second Headline

const descriptionHeading2 = "Welcher Vertiefung  passt zu mir?";


// 	1.6.4. Kurzer Text um was es bei der Wahl geht / 1.6.3. Short (descriptive) text on what's the election about

const descriptionExplanation = "Beantworte im Folgenden einfach ein paar Fragen zu deinen Interessen und finde heraus, welche Vertiefung für dich interessant ist."; 
...
*/
	...
	const imprintLink = "https://www.h-ka-w.de/impressum" // "system/imprint.html"
